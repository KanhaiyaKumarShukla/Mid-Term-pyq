...
class year_23_Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_year23)
        ...
        sem_1_btn.setOnClickListener{
            val intent=Intent(this, subject_23_1_Activity::class.java)
            startActivity(intent)
            finish()
        }
        sem_2_btn.setOnClickListener{
            val intent=Intent(this, subject_23_2_Activity::class.java)
            startActivity(intent)
            finish()
        }
        sem_3_btn.setOnClickListener{
            val intent=Intent(this, subject_23_3_Activity::class.java)
            startActivity(intent)
            finish()
        }
        sem_4_btn.setOnClickListener{
            val intent=Intent(this, subject_23_4_Activity::class.java)
            startActivity(intent)
            finish()
        }
        sem_5_btn.setOnClickListener{
            val intent=Intent(this, subject_23_5_Activity::class.java)
            startActivity(intent)
            finish()
        }
        sem_6_btn.setOnClickListener{
            val intent=Intent(this, subject_23_6_Activity::class.java)
            startActivity(intent)
            finish()
        }
        sem_7_btn.setOnClickListener{
            val intent=Intent(this, subject_23_7_Activity::class.java)
            startActivity(intent)
            finish()
        }
        sem_8_btn.setOnClickListener{
            val intent=Intent(this, subject_23_8_Activity::class.java)
            startActivity(intent)
            finish()
        }
    }
